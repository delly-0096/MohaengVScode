...
function Tours() {
  ...
  const handleApprove = async (tripProdNo) => {
    if (!window.confirm("이 상품을 승인하시겠습니까?\n승인 시 즉시 '판매중' 상태로 전환됩니다.")) return;
            ...
            {toursData.map(tour => {
              ...
              return (
                ...
                >
                  ...
                  <td style={{ fontWeight: 500, color: '#2563eb' }}>{formatPrice(tour.price)}</td>
                  <td style={{ fontWeight: 600 }}>
                    <span style={{ 
                      ...
                      <i className={`bi ${tour.curStock <= 3 ? 'bi-exclamation-triangle-fill' : 'bi-box-seam'}`}></i>
                      {tour.curStock || 0}개
                    </span>
                  </td>
                  <td>
                    <span className={`status-badge ${
                      displayStatus === '판매중' ? 'active' : 
                    ...
                    <div className="action-buttons">
                      ...
                      {isPending ? (
                        ...
                        <button 
                          ...
                          title={displayStatus === '판매중' ? '판매 중지' : '판매 시작'} 
                          onClick={() => toggleStatus(tour)}
                        >
                          <i className={`bi ${displayStatus === '판매중' ? 'bi-pause-circle-fill' : 'bi-play-circle-fill'}`}></i>
                        </button>
                      )}
                    </div>
                  </td>
              ...
              <div className="detail-grid">
                ...
                <div className="detail-section" style={{ background: '#fff', borderRadius: '16px', padding: '24px', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
                  <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '20px', borderBottom: '2px solid #f1f5f9', paddingBottom: '12px' }}>
                    <i className="bi bi-ticket-perforated-fill" style={{ color: '#4f46e5' }}></i>
                    <span>상품 기본 정보</span>
                  </h3>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        ...
                        <span style={{
                          ...
                          fontSize: '0.85rem',
                          fontWeight: 800,
                          background: getDisplayStatus(selectedTour) === '판매중' ? '#dcfce7' : getDisplayStatus(selectedTour) === '승인대기' ? '#fef3c7' : '#f1f5f9',
                          color: getDisplayStatus(selectedTour) === '판매중' ? '#166534' : getDisplayStatus(selectedTour) === '승인대기' ? '#92400e' : '#64748b',
                          border: getDisplayStatus(selectedTour) === '판매중' ? '1px solid #bbf7d0' : getDisplayStatus(selectedTour) === '승인대기' ? '1px solid #fde68a' : '1px solid #e2e8f0'
                        }}>
                          <i className={`bi ${getDisplayStatus(selectedTour) === '판매중' ? 'bi-play-circle-fill' : getDisplayStatus(selectedTour) === '승인대기' ? 'bi-clock-fill' : 'bi-pause-circle'} me-1`}></i>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginTop: '4px' }}>
                      {/* 카테고리 */}
                      <div>
                        <span style={{ fontSize: '0.85rem', color: '#94a3b8', fontWeight: 600, display: 'block', marginBottom: '6px' }}>카테고리</span>
                      ...
                      {/* 소요시간 */}
                      <div>
                        <span style={{ fontSize: '0.85rem', color: '#94a3b8', fontWeight: 600, display: 'block', marginBottom: '6px' }}>소요시간</span>
                    ...
                    <div style={{ borderTop: '1px solid #f1f5f9', paddingTop: '16px' }}>
                      <span style={{ fontSize: '0.85rem', color: '#94a3b8', fontWeight: 600, display: 'block', marginBottom: '8px' }}>지역</span>
                ...
                <div className="detail-section" style={{ background: '#fff', borderRadius: '16px', padding: '24px', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
                  <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '20px', borderBottom: '2px solid #f1f5f9', paddingBottom: '12px' }}>
                    <i className="bi bi-currency-dollar" style={{ color: '#4f46e5' }}></i>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div style={{ display: 'flex', gap: '24px' }}>
                        <div style={{ textAlign: 'center' }}>
                          <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginBottom: '4px' }}>정가</div>
                          <div style={{ fontWeight: 600, color: '#64748b', fontSize: '1rem', textDecoration: selectedTour.discount > 0 ? 'line-through' : 'none' }}>
                            {formatPrice(selectedTour.netprc)}
                          </div>
                        </div>
                        <div style={{ width: '1px', height: '30px', background: '#e2e8f0', alignSelf: 'center' }}></div>
                        <div style={{ textAlign: 'center' }}>
                          <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginBottom: '4px' }}>판매가</div>
                        ...
                        {selectedTour.discount > 0 && (
                          <>
                            <div style={{ width: '1px', height: '30px', background: '#e2e8f0', alignSelf: 'center' }}></div>
                            <div style={{ textAlign: 'center' }}>
                              <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginBottom: '4px' }}>할인율</div>
                    ...
                    <div style={{ 
                      ...
                      <div>
                        ...
                        <span style={{ color: '#1e293b', fontWeight: 600, marginLeft: '8px' }}>
                          {formatDate(selectedTour.saleStartDt)} ~ {formatDate(selectedTour.saleEndDt)}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="detail-section full-width" style={{ marginTop: '24px' }}>
                  <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
                    <i className="bi bi-building" style={{ color: '#4f46e5' }}></i>
                    <span>판매자 정보</span>
                  </h3>
                    ...
                    <div style={{ 
                      ...
                      <div style={{
                        ...
                        {selectedTour.sellerProfileImage ? (
                          ...
                          <i className="bi bi-building" style={{ fontSize: '28px', color: '#94a3b8' }}></i>
                        )}
                      </div>
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ fontSize: '0.9rem', color: '#64748b', lineHeight: 1.6 }}>
                          {selectedTour.sellerIntro || '업체 소개가 등록되지 않았습니다.'}
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div style={{
                      ...
                      {selectedTour.imageList.map((image, idx) => (
                        <div key={image.fileNo || idx} style={{ 
                          ...
                          border: idx === 0 ? '3px solid #2563eb' : '1px solid #e2e8f0',
                          aspectRatio: '3/2'
                        }}>
                          <img
                ...
                <div className="detail-section full-width" style={{ marginTop: '32px' }}>
                  ...
                  <div style={{ 
                    ...
                    <div style={{ 
                      ...
                      <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginBottom: '6px' }}>운영 시간</div>
                      <div style={{ fontWeight: 600, color: '#1e293b' }}>{selectedTour.prodRuntime || '-'}</div>
                    </div>
                    <div style={{ 
                      padding: '16px', 
                      background: '#fff', 
                      ...
                      <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginBottom: '6px' }}>소요 시간</div>
                      <div style={{ fontWeight: 600, color: '#1e293b' }}>{selectedTour.prodDuration || '-'}</div>
                    </div>
                    <div style={{ 
                      padding: '16px', 
                      background: '#fff', 
                      ...
                      <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginBottom: '6px' }}>연령 제한</div>
                      <div style={{ fontWeight: 600, color: '#1e293b' }}>{selectedTour.prodLimAge || '-'}</div>
                    </div>
                    <div style={{ 
                      padding: '16px', 
                      background: '#fff', 
                      ...
                      <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginBottom: '6px' }}>인원</div>
                      <div style={{ fontWeight: 600, color: '#1e293b' }}>
                        최소 {selectedTour.prodMinPeople || 1}명 ~ 최대 {selectedTour.prodMaxPeople || 99}명
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="detail-section full-width" style={{ marginTop: '24px' }}>
                  <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
                    <i className="bi bi-calendar-check" style={{ color: '#059669' }}></i>
                    <span>예약 가능 시간</span>
                  </h3>
                      ...
                      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                        {selectedTour.prodTimeList.map((time, idx) => (
                          <span key={idx} style={{
                            ...
                            <i className="bi bi-clock" style={{ color: '#059669' }}></i>
                ...
                <div className="detail-section" style={{ marginTop: '24px' }}>
                  ...
                  <div style={{
                    ...
                    {selectedTour.prodInclude ? (
                      ...
                      <div style={{ textAlign: 'center', color: '#86efac', padding: '10px 0' }}>
                        <i className="bi bi-info-circle me-2"></i>등록된 정보가 없습니다.
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="detail-section" style={{ marginTop: '24px' }}>
                  ...
                  <div style={{
                    ...
                    {selectedTour.prodExclude ? (
                      ...
                      <div style={{ textAlign: 'center', color: '#fca5a5', padding: '10px 0' }}>
                        <i className="bi bi-info-circle me-2"></i>등록된 정보가 없습니다.
                      </div>
                    )}
                  </div>
                ...
                {selectedTour.prodNotice && (
                  <div className="detail-section full-width" style={{ marginTop: '24px' }}>
                    <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
                      <i className="bi bi-exclamation-triangle" style={{ color: '#d97706' }}></i>
                      <span>유의 사항</span>
                    </h3>
              ...
              <div style={{ display: 'flex', gap: '14px', alignItems: 'center' }}>
                ...
                {selectedTour?.aprvYn === 'Y' && (
                  <button 
                    ...
                    style={{ 
                      border: '2px solid',
                      borderColor: getDisplayStatus(selectedTour) === '판매중' ? '#ef4444' : '#3b82f6', 
                      color: getDisplayStatus(selectedTour) === '판매중' ? '#ef4444' : '#3b82f6', 
                    ...
                    onMouseOver={(e) => {
                      e.currentTarget.style.background = getDisplayStatus(selectedTour) === '판매중' ? '#fef2f2' : '#eff6ff';
                    }}
                    onMouseOut={(e) => {
