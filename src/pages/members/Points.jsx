    ...
    <div className="products-page">
      ...
      <div className="stats-grid">
        <div className="stat-card">
          ...
          <div className="stat-content">
            <span className="stat-value">
              {new Intl.NumberFormat("ko-KR").format(stats.TOTAL_EARNED)}P
            </span>
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <span className="stat-value">
              {new Intl.NumberFormat("ko-KR").format(stats.TOTAL_USED)}P
            </span>
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <span className="stat-value">
              {new Intl.NumberFormat("ko-KR").format(stats.TOTAL_EXPIRED)}P
            </span>
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <span className="stat-value">
              {new Intl.NumberFormat("ko-KR").format(stats.TOTAL_BALANCE)}P
            </span>
                  ...
                  <tr key={index}>
                    <td>
                      ...
                      <small className="text-muted">
                        {new Date(point.regDt).toLocaleTimeString("ko-KR")}
                      </small>
                    </td>
                    <td>
                    ...
                    <td>
                      <span
                        className={`point-amount ${point.pointAmt >= 0 ? "positive" : "negative"}`}
                      >
